...
# This is saying take the absolute value of -2 to the power of 4.3, rounding 
# 4.3 to the nearest whole number
...
# Unlike int, round actually DOES round up
# int converts a float into an int, but it rounds down
# round converts a float into an int, but it rounds up 

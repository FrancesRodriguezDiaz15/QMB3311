...
# Calculate the function, denoting the answer as a whole number with the remainder separate

# Answer excluding decimal remainder

def Integer_Division(x: float, y: float) -> float:
    """ Camputes integer division
    >>> 20 // 24
        (0, 20)
    >>> 24 // 6
        (4, 0)
...
print("#" + 50*"-")
print("Testing my Examples for Integer_Division function")
print("#" + 50*"-")
print ("Testing Exercise 1")
print("#" + 50*"-")
print("Expected: " + str((0, 20)))
print("#" + 50*"-")
print("Got: " + str(Integer_Division(20, 24)))
...
print("Expect: " + str(4))
print("Got: " + str(Integer_Division(24, 6)))
...
# returns an int lower b/c we're dividing by a negative  

# When a sign is negative, the sign of the modulo output is 
# the sign of the divisor (the second operand).

# According to python, -17/10 = -1.7 which rounds down to -2
# 2*10 = 20 -> 17 - 20 = 3
# 2nd number is positive, so 3 -> 3

-17 % 10

# According to python,  17/-10 = -1.7; we are dividing by a (-), so we round 
# down to -2
# 10*-2 = -20 -> according to python, sign is not yet determined
# 17 - 20 = 3 -> 2nd number is negative, so -3
...
3.3 // 1
# 3.3/1 =  3.3 -> rounds down to 3.0

3 // 1.0
# 3/1.0 = 3.0

3 // 1.1
# 3/1.1 = 2.727 -> rounds down to 2.0; include a .0 b/c we are dividing a float

3.5 // 1.1
# = 3.19 rounds down to 3.0

3.5 // 1.3
# 2.69  rounds down to 2
...
score += 20
score
# This is saying score is equal to score + 20; score currently = 50 sp 50+20
# = 70
...
d *= 3 + 4
d
# This is saying d = d*3 + d*4
# Therefore d = 2*3 + 2*4 = 6 + 8 = 14
